...
model_type = '../add_token/new_vo/sqlite3_two'

software_name = 'glpk'

read_inst_dir = "../add_token/data" + os.sep + "newjson" + os.sep + software_name
save_dir = './changebert' + os.sep + "glpk_two"
...
for arch_path in arch_paths:
    ...
    bert_model = AutoModel.from_pretrained("/home/ubuntu/Desktop/2t_disk/ABERT/Bert/finetune_bert/data/model_save/changebert/sqlite3_two/sqlite3/new_data3.csv03_17_12_46", output_hidden_states = True)
