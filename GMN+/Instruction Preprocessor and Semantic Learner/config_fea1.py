...
DataTransferInstr = ['lea', 'mov', 'movq', 'movzx', 'movsd', 'movsxd', 'movapd',
                     ...
                     'STRHGE', 'movn.d', 'movlpd', 'STMDA', 'LDMLT', 'STMEALT', 'STMLS', 'LDRHCC']
...
ArithmeticInstr = ['add', 'sub', 'imul', 'mulsd', 'addsd', 'adc', 'subsd', 'mul', 'neg',
                   ...
                   'mulps', 'psubw', 'pmullw', 'ADDPL', 'ANDCC', 'MULGT', 'MLAEQ', 'MLAGT', 'SMULLLE',
                   'UMULLGT', 'SMULLGE', 'SMULLLT', 'MLAGE', 'SMULLGT']
...
ControlFlowInstr = ['jmp', 'call', 'jz', 'jnz', 'je', 'jnz', 'jg', 'jge', 'jle', 'jge', 'jl',
                    ...
                    'BXLT', 'BXGT', 'BLEQ', 'BXCC', 'BXCS', 'BXLS', 'BXLT', 'BXGE', 'BVS', 'BVC']
...
BitInstr = ['sar', 'shr', 'shl', 'srl', 'sra', 'sll', 'srlv', 'sllv', 'srlv', 'shrd', 'srav',
            ...
            'shufps', 'unpcklps', 'cld', 'CLZNE','psrad', 'EORLE', 'BICLT', 'BICGE', 'ANDCC',
            'CLZGT', ]

ConditionalTransferInstr = ['cmova', 'cmovnb', 'cmovle', 'cmovge', 'cmovg', 'cmovnz', 'cmovl',
                            'cmovz', 'cmovns', 'cmovs', 'cmovb', 'cmovbe', 'movn', 'movz', 'movf', 'movt', 'MVNNE',
                            'LDRHGT', 'LDRHLT', 'LDRPL', 'LDMGT', 'STMGT', 'MVNLT', 'LDRSHLT',
                            'LDMFDLE', 'STMLE', 'LDRSBNE', 'LDRSBLT', 'LDRSBLS', 'LDRSBGT', 'LDRSBGT',
                            'LDRSBLE', 'LDRBLE', 'LDRHLS', 'STRHLS', 'LDRSHEQ', 'MOVVC', 'STMLT',
                            'STMIBEQ', 'STRHCS','LDRSHLE', 'LDMEDEQ', 'LDMIBEQ', 'MOVVS']
...
StackInstr = ['push', 'pop', 'STM', 'LDM', 'leave','PUSH','POP','POPEQ', 'POPNE', 'POPHI',
              'POPLE', 'POPGT', 'POPLS', 'POPMI', 'POPCC', 'POPLT', 'POPGE', 'POPCS']
...
CompareInstr = ['CMP', 'CMN', 'test', 'TST', 'TEQ', 'ucomisd', 'cmp', 'pcmpeqd', 'pcmpeqb',
                ...
                'c.un.s', 'c.eq.s', 'c.le.s', 'c.ueq.d', 'c.ult.d', 'CMNLS', 'CMNLT', 'CMPLT']
