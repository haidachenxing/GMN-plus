...
def update_config_datasetone(config_dict):
    ...
    experiment_list = ["comparative", "ablation", "vulsearch", "temperature"]
    ...
    feature_dataset_basic_path = "/home/ubuntu/Desktop/2tdisk/zth/gmm_data"
    # feature_dataset_basic_path = "/media/ubuntu/6a197cd7-03ba-495b-9b4a-942d0862fe17/gmm_data"
    config_dict['training']['features_train_path'] = feature_dataset_basic_path + os.sep + program_name + os.sep + "data_final/func_date.json"
    ...
    config_dict['model_dir'] = inputdir + os.sep + program_name + os.sep + "model_08" + os.sep + "model.pth"

    config_dict['model_pp'] = inputdir + os.sep + program_name + os.sep + "model_08"
    ...
    config_dict['testing'] = dict(
        ...
        comparative_list_inputs=os.path.join(basic_path, experiment_list[experiment_type], program_name, "test", "test_vul"),
        comparative_list_outputs=os.path.join(basic_path, experiment_list[experiment_type], program_name, "result", "test_vul"),

        vul_list_inputs=os.path.join(basic_path, experiment_list[experiment_type], program_name, "vul_list3"),
        vul_list_outputs=os.path.join(basic_path, experiment_list[experiment_type], program_name, "result", "vul_list3"),
