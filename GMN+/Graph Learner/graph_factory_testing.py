...
class GraphFactoryTesting(GraphFactoryBase):
    ...
    def __init__(self, pos_path, neg_path, feat_path, batch_size,
        ...
        print ("Batch size (validation): {}".format(self._batch_size))
        ...
        # self._num_func_pairs = 40

        print ("Tot num func pairs (validation): {}".format(
        ...
        print ("Num batches (validation): {}".format(self._num_batches))
    ...
    def _get_next_pair(self):
        ...
        while True:
            print ("(Re-)initializing the iterators")
            ...
            for _ in range(self._num_func_pairs):
                ...
                p_aol = pos['arch_1'] + '_' + pos['opti_1']
                p_aor = pos['arch_2'] + '_' + pos['opti_2']

                n_aol = neg['arch_1'] + '_' + neg['opti_1']
                n_aor = neg['arch_2'] + '_' + neg['opti_2']

                f_pl = self._fdict[pos['func_name_1']][p_aol]
                f_pr = self._fdict[pos['func_name_2']][p_aor]

                f_nl = self._fdict[neg['func_name_1']][n_aol]
                f_nr = self._fdict[neg['func_name_2']][n_aor]
